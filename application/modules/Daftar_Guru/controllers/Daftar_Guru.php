...
class Daftar_Guru extends MX_Controller {
	function __construct()
	{
		parent::__construct();
		{
			$this->load->model(array(
				'Daftar_guru_model'			=> 'guru',
	...
	{
		$where = array('id'=> $id);
		$this->tambah_petugas->hapus_data($where,'guru');
		$this->session->set_flashdata('msg','Data Berhasil di Hapus');
		redirect('Daftar_Guru');
	}
	function edit($id)
	{
		$where = array('id' => $id);
		$data['guru'] = $this->guru->edit_data($where,'guru')->result();
	...
	function update()
	{
		...
		if ($berkas == null) {
			...
			$this->guru->update_data($where,$data,'guru');
			redirect('Daftar_Guru');
			}
			else{	
